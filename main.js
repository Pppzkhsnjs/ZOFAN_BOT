...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '👋 ة¡حللت أهلا ووطئت سهلا أهلا بك بين إخوتك وأخواتك إن شاء الله تسعد تسعدنا معك وأتمنى إن تستفيد وتفيدنا بمشاركتك وابداعاتك سعداء بوجودك معانا حياك الله. بقلوب ملؤها المحبة وأفئدة تنبض بالمودة وكلمات تبحث عن روح الأخوة.. نقول لك أهلاً وسهلاً.!\n@user';
  conn.bye = '👋 ¡مركب اللي تودي مترجعش!\n@user';
